    ...
    return {
      ...
      blocks: {
        1: {
          ...
          teaser: {text: 'bottom', width: 200, height: 260, gap: 5, borderRadius: 10, paddingInline: 0, paddingBlock: 0, showBorder: false, backgroundColor: '#ffffff', showBtn: true, zoom: true, shadow: true, imgFr: 3, textFr: 2,},
          text: {
            bold: true,
            italic: false,
            underline: false,
